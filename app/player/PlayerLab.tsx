//app\(dashboard)\course\CoursePlayerLab.tsx
// deno-lint-ignore-file
  ...
  export default function CoursePlayerClient() {
   ...
   useEffect(() => {
    ...
    // NEW: track if promo has already been shown once
    const promoShownOnceRef = useRef(false);
...
"
      ...
      <div
        ...
        className="h-[165px] backdrop-blur-sm w-full bg-white/25"
      />
...
<div
  id="timeline-region"
  className="fixed bottom-[15px] sm:bottom-[15px] md:bottom-[10px] left-0 right-0 z-40 
...
>
      ...
      />
        ...
        <div
          className="
            absolute
            bottom-[10px] sm:bottom-[10px] md:bottom-[10px]
            left-0 right-0
            z-[200]
            pointer-events-auto
          "
...
return (
  <div
    className={`
      ...
      bottom-[125px] sm:bottom-[100px] md:bottom-[110px]
      z-40
      flex justify-center
      pointer-events-none
      transition-all duration-300 ease-out
      ${showTimeline ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}
    `}
  >
    <div className="bg-black/70 ml-43 mr-43 px-43 py-1.5">
      <KaraokeCaption
        captions={captions}
